 ...
 * 
 */
@WebServiceClient(name = "OrderServiceService", targetNamespace = "http://service.orders/", wsdlLocation = "http://localhost:8090/orders?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICESERVICE_QNAME = new QName("http://service.orders/", "OrderServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/orders?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://service.orders/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.orders/", "OrderServicePort"), OrderService.class, features);
    }
